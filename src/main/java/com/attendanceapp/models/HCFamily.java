 ...
 */
public class HCFamily implements Serializable {
    private String id,name,email,profilePicName,phone,locationName,locationId,employeeId,companyName,companyCode,startTime,endTime,startDate,endDate,longitude,latitude;
