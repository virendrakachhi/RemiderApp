...
public class HCModuleReportActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showReportData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent showReportIntent = new Intent(HCModuleReportActivity.this, HCModuleShowDetailedReportActivity.class);
    ...
    public void calenderButtonClicked(final View v) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(HCModuleReportActivity.this);
