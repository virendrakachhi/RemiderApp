...
public class Manager_DashboardActivity extends FragmentActivity implements View.OnClickListener, NavigationPage.NavigationFunctions {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userUtils = new UserUtils(Manager_DashboardActivity.this);
    ...
    private void absenceLayout() {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            ProgressDialog dialog = new ProgressDialog(Manager_DashboardActivity.this);
            ...
            protected void onPostExecute(String result) {
                ...
                if (result != null) {
                    try {
                        ...
                        Intent intent = new Intent(Manager_DashboardActivity.this, Absent.class);
    ...
    private void makeToast(String title) {
        Toast.makeText(Manager_DashboardActivity.this, title, Toast.LENGTH_LONG).show();
    }
    ...
    private void updateDataAsync() {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                hm.put("role", String.valueOf(UserRole.Manager.getRole()));
                try {
    ...
    public void takeAttendance(final String attendanceUsing) {
        ...
        new AsyncTask<Void, Void, String>() {
            private ProgressDialog dialog = new ProgressDialog(Manager_DashboardActivity.this);
