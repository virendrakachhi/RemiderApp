...
public class Parent_ChildClassExpendableListAdapter extends BaseExpandableListAdapter {
    ...
    public Parent_ChildClassExpendableListAdapter(Activity context, TreeMap<String, List<Attendance>> classAttendanceMap) {
