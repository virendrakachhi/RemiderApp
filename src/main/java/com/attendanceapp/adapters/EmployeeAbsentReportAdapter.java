...
public class EmployeeAbsentReportAdapter extends BaseExpandableListAdapter {
    ...
    public EmployeeAbsentReportAdapter(Activity context, TreeMap<String, List<Attendance>> classAttendanceMap) {
