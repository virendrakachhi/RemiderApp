...
public class FamilyPagerAdapter extends FragmentPagerAdapter {
    ...
    List<? extends HCFamily> classEventCompanyList;

    public FamilyPagerAdapter(FragmentManager supportFragmentManager, List<? extends HCFamily> classEventCompanyList) {
